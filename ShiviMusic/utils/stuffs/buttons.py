...
class BUTTONS(object):
    ABUTTON = [
    [
        InlineKeyboardButton("˹ sυᴘᴘσʀᴛ ˼", url="https://t.me/Cc_Heroku", style=ButtonStyle.PRIMARY),
        InlineKeyboardButton("˹ υᴘᴅᴧᴛєs ˼", url="https://t.me/+KHpnmtJn_r1jMmU1", style=ButtonStyle.SUCCESS)
    ],
    [
